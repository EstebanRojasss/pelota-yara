...
import com.forum.api.infra.adapter.rest.dto.JugadorRequestDto;
import com.forum.api.infra.adapter.rest.dto.JugadorResponseDto;
...
public class JugadorController {
    ...
    public ResponseEntity<JugadorResponseDto> agregarNuevoJugador(@RequestBody JugadorRequestDto jugadorDto) {
        JugadorResponseDto response = JugadorResponseDto
                .fromDomain(
                        jugadorService.agregarNuevoJugador(jugadorDto.toDomain())
                );
